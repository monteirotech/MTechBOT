...
//internet android\\
keyapissh = "https://api.gestorvip.com/monteirotech/1.php"
valor1 = "R$ 15,00"
linkpag ="https://mpago.la/17Umsnc"


//internet ios\\
keyapissh2 = "https://api.gestorvip.com/monteirotech/2.php"
valor2 = "R$ 25,00"
linkpag2 ="https://mpago.la/1ustu4g"

//iptv\\
keyapissh3 = "https://api.gestorvip.com/monteirotech/3.php"
valor3 = "R$ 35,00"
linkpag3 ="https://mpago.la/1DR6Bz9"

//testessh\\
keyapissh4 = "https://api.gestorvip.com/monteirotech/free.php"

//link do aplicativo de conexão vps\\
linkapp = "https://bit.ly/AtlantusTech4G"
...
case 'menuoff':
botaoale = [
{title: "Selecione a opção desejada rolando até embaixo:",
rows: [
{title: "🆓 Testes Grátis", rowId: `${prefix}testesgratis`, description: "🚀 Internet Ilimitada | 📺 IPTV (Assista TV usando internet)"},
{title: "🤝👤 Sou cliente", rowId: `${prefix}menu1`, description: "Área exclusiva para nossis usuários"},
{title: "Não sou cliente", rowId: `${prefix}menu2`, description: "Quero ser cliente"},
{title: "👤 Mentoria ESIGN", rowId: `${prefix}mentoria`, description: "Whatsapp GB para iPhone"}]
}]
sendlistA(from, "⚠️ Este atendimento é feito 100% por um Robô, não há nenhuma pessoa aqui falando com você.", ``,`${NomeDoBot}`, "Iniciar Atendimento | Menu", botaoale)
break
...
rows: [
{title: "🆓 Testes Grátis", rowId: `${prefix}testesgratis`, description: "🚀 Internet Ilimitada | 📺 IPTV (Assista TV usando internet)"},
{title: "💰 Financeiro", rowId: `${prefix}financeirogeral`, description: "Pagar | Contratar | Renovar | Enviar Comprovante"},
{title: "❌ Resolver Erros e Problemas", rowId: `${prefix}erroseproblemas`, description: "Resolver problemas nos nossos aplicativos"},
{title: "⬇️ Baixar Aplicativos", rowId: `${prefix}apps`, description: "Loja de APPs de Internet ilimitada | IPTV (TV)"},
{title: "ℹ️ Meus Dados", rowId: `${prefix}meusdados`, description: "Usuário e Senha (Clientes)"},
{title: "📝 Tutoriais", rowId: `${prefix}tutoriaisiptv`, description: "Entrar | Sair | Atualizar Conteúdos (IPTV)"},
{title: "👤 Mentoria ESIGN", rowId: `${prefix}mentoria`, description: "Instalar Whatsapp GB no iPhone"},
{title: "🗣️ SAC", rowId: `${prefix}sac`, description: "Dúvidas, Sugestões e Elogios"}]
}]
sendlistA(from, "⚠️ Este atendimento é feito 100% por um Robô, não há nenhuma pessoa aqui falando com você.", `(versão beta)`,`${NomeDoBot}`, "Iniciar Atendimento | Menu", botaoale)
break
...
rows: [
{title: "🆓 Testes Grátis", rowId: `${prefix}testesgratis`, description: "🚀 Internet Ilimitada | 📺 IPTV (Assista TV usando internet)"},
{title: "💰 Financeiro", rowId: `${prefix}financeirogeral`, description: "Pagar | Contratar | Renovar"}]
}]
sendlistA(from, "⚠️ Este atendimento é feito 100% por um Robô, não há nenhuma pessoa aqui falando com você.", ``,`${NomeDoBot}`, "Iniciar Atendimento | Menu", botaoale)
break
...
rows: [
  {title: "🚀 Internet Ilimitada - Android", rowId: `${prefix}internetandroid`, description: ""},
  {title: "🚀 Internet Ilimitada - iPhone", rowId: `${prefix}internetios`, description: ""},
  {title: "📺 IPTV - (Assista TV usando Internet)", rowId: `${prefix}testeiptv`, description: ""},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: "️"}]
}]
sendlistA(from, "Disponíveis por até 03Hrs\n", `Confira nossa tabela de valores (1 mês):\n\n🚀 Internet Ilimitada Android - ${valor1} \n🚀 Internet Ilmitada iPhone - ${valor2} \n\n📺 IPTV (Tv via Internet) - ${valor3}`, "Testes Grátis", "Escolha um Teste Grátis", botaoale)
break

case 'internetandroid':
botaoale = [
{title: "Escolha sua operadora:",
rows: [
  {title: "🟣 Vivo", rowId: `${prefix}vivoandroid`, description: ""},
  {title: "🔵 Tim", rowId: `${prefix}testetimandroid`, description: ""},
  {title: "🔴 Claro", rowId: `${prefix}testeclaroandroid`, description: ""},
  {title: "🟡 Oi", rowId: `${prefix}testeoiandroid`, description: ""},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "Requisitos:", `01 chip *funcionando* com sinal no mínimo 3G da operadora, o chip *não* pode está bloqueado !

*NÃO* precisa ter crédito ou bônus para internet.`, "*Teste Internet Android Escolhido ✅*", "Operadoras Disponíveis", botaoale)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "🔜 Prosseguir - Gerar Teste", rowId: `${prefix}testevivoandroid`, description: "Baixar Aplicativo e Receber Dados de Login"},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "*Operadora VIVO*", `\r1️⃣ - No aparelho: vá em Configurações | Ajustes
2️⃣ - Pesquise por: *Pontos de Acesso* e abra
3️⃣ - Clique para editar o ponto de acesso onde já estiver selecionado, *Vivo internet / zap.vivo.com.br* por exemplo
4️⃣ - Procure por *PROTOCOLO DE APN* e selecione *IPV4*
5️⃣ - Procure por *PROTOCOLO DE ROAMING DO APN* e selecione *IPV4*
6️⃣ - Salve a alteração
7️⃣ - Reinicie seu celular e clique em continuar 👇🏻`, "*Configuração Necessária*", "Continuar | Ajuda", botaoale)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "🔜 Prosseguir - Gerar Teste", rowId: `${prefix}testetimandroid`, description: "Baixar Aplicativo e Receber Dados de Login"},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "*Operadora TIM*", `Operadora *TIM* indisponível para quem está com os créditos *EXPIRADOS*.

👉🏼 Verifique em: *222#

Se aparecer data de validade, aperte em *Continuar*.

Se estiver expirado, terá que fazer uma recarga para liberar seu *CHIP*.

Conseguimos um cupom de desconto para você recarregar seu *TIM* com *R$ 20,00* e pagar apenas *R$ 10,00*.

Você só precisa baixar o App e fazer sua 1ª (recarga) pelo:
http://recargapay.com.br/r/gabmon473-8YG
ou usar o cupom: gabmon473.

Dessa forma você conseguirá usar nosso serviço e desbloquear seu *CHIP* gastando apenas *R$ 10,00* e recebendo *R$ 20,00*.`, "*Verificação Necessária*", "Continuar | Ajuda", botaoale)
break


//inicio teste operadoras Android 

case 'testevivoandroid':
reply(`Aguarde um momento, caso seu teste seja aceito, será enviado aqui.`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Solicitação de Teste - VIVO Android*\n\n_Deseja enviar ?_\n\nNúmero dele(a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [
{buttonId: `${prefix}gerartesteandroid ${sender}`, buttonText: {displayText: `Aceitar`}, type: 1},
{buttonId: `${prefix}testeindisponivel ${sender}`, buttonText: {displayText: `Indisponível`}, type: 1}], selo)
break

case 'testetimandroid':
reply(`Aguarde um momento, caso seu teste seja aceito, será enviado aqui.`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Solicitação de Teste - TIM Android*\n\n_Deseja enviar ?_\n\nNúmero dele(a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [
{buttonId: `${prefix}gerartesteandroid ${sender}`, buttonText: {displayText: `Aceitar`}, type: 1},
{buttonId: `${prefix}testeindisponivel ${sender}`, buttonText: {displayText: `Indisponível`}, type: 1}], selo)
break

case 'testeclaroandroid':
reply(`Aguarde um momento, caso seu teste seja aceito, será enviado aqui.`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Solicitação de Teste - CLARO Android*\n\n_Deseja enviar ?_\n\nNúmero dele(a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [
{buttonId: `${prefix}gerartesteandroid ${sender}`, buttonText: {displayText: `Aceitar`}, type: 1},
{buttonId: `${prefix}testeindisponivel ${sender}`, buttonText: {displayText: `Indisponível`}, type: 1}], selo)
break
...
case 'testeoiandroid':
reply(`Aguarde um momento, caso seu teste seja aceito, será enviado aqui.`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Solicitação de Teste - OI Android*\n\n_Deseja enviar ?_\n\nNúmero dele(a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [
{buttonId: `${prefix}gerartesteandroid ${sender}`, buttonText: {displayText: `Aceitar`}, type: 1},
{buttonId: `${prefix}testeindisponivel ${sender}`, buttonText: {displayText: `Indisponível`}, type: 1}], selo)
break

//fim teste operadoras Android 

//inicio teste SSH

case 'gerartesteandroidORIGINAL':
if(!SoDono) return reply("Só dono...")
await conn.sendMessage(q, {text: `Seu *Teste* foi aceito, aguarde um momento...`})
server = await fetchJson(`${keyapissh4}`)
if (server.error) return reply(server.error)
botaoale = [
{title: "Selecione a opção desejada:",
rows: [
{title: "⬇️ Baixar Aplicativo", rowId: `${prefix}appinternetandroid`, description: "Aplicativo de conexão"},
{title: "💰 Efetuar Pagamento", rowId: `${prefix}financeirovps`, description: "Comprar | Pagar | Contratar"},
{title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
{title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(q, "━━━━━━━━━━━━━━━━━", `➥ 👤 Usuário: ${server.user}\n(digite igual está escrito)\n➥ 🔒 Senha: ${server.pass}\n➥ ⌛ Tempo do Teste: 03hrs\n\n⬇️ *Baixe o APP aqui*:\nhttps://bit.ly/AtlantusTech4G\n(após abrir, clique no botão DOWNLOAD)`, `Teste Gerado com Sucesso ✅`, "Contratar | Ajuda", botaoale)
break

case 'gerartesteandroid':
if(!SoDono) return reply("Só dono...")
await conn.sendMessage(q, {text: `Seu *Teste* foi aceito ✅

*Baixe nosso aplicativo - (ATLANTUS TECH 4G):*\nhttps://bit.ly/AtlantusTech4G
(após abrir, clique no botão DOWNLOAD)`})
server = await fetchJson(`${keyapissh4}`)
if (server.error) return reply(server.error)
botaoale = [
{title: "Selecione a opção desejada:",
...
sendlistA(q, "━━━━━━━━━━━━━━━━━", `
🟢 *Ligue* seu Wi-Fi 
*Instale e Abra* o aplicativo *Atlantus Tech 4G*
Aguarde *Atualizar*
🔴 *Desligue* o Wi-Fi
🟢 *Ligue* os dados móveis

*Defina* sua operadora
(Existem várias opções, teste *TODAS* !)
...
Caso algo dê errado, reinicie o celular e tente conectar novamente.
`, `Teste Gerado com Sucesso ✅`, "Contratar | Preciso de Ajuda", botaoale)
break

case 'recusartesteandroid':
if(!SoDono) return reply("Só dono...")
conn.sendMessage(q, {text: `Olá Amigo (a), sinto muito dizer, mas seu *Teste* foi recusado, talvez você já tenha solicitado outro teste dentro de 30 dias, caso deseje adiquirir um plano mensal acesse o menu principal.`})
break

case 'testeindisponivel':
if(!SoDono) return reply("Só dono...")
conn.sendMessage(q, {text: `*Operadora indisponível no momento, avisaremos quando voltar ao normal.*`})
break

//fim do teste ssh Android

// aviso ios 

case 'internetios':
reply(`*Serviço temporariamente indisponível, iremos agendar seu número e informar quando o serviço retornar.*`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Solicitação de aviso iOS.*\n\n_Deseja confirmar o aviso ?_\n\nNúmero dele(a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [
{buttonId: `${prefix}avisoios ${sender}`, buttonText: {displayText: `Sim`}, type: 1},], selo)
break

case 'avisoios':
if(!SoDono) return reply("Só dono...")
await conn.sendMessage(q, {text: `Contato Salvo ✅`})
break
...
{title: "Escolha sua operadora:",
rows: [
  {title: "🟣 Vivo", rowId: `${prefix}vivoandroid`, description: "Disponível por até 03H ⌛"},
  {title: "🔵 Tim", rowId: `${prefix}sshandroid`, description: "Disponível por até 03H ⌛"},
  {title: "🔴 Claro", rowId: `${prefix}sshandroid`, description: "Disponível por até 03H ⌛"},
  {title: "🟡 Oi", rowId: `${prefix}sshandroid`, description: "Disponível por até 03H ⌛"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "iOS - iPhone", `\r𝒔𝒆𝒍𝒆𝒄𝒊𝒐𝒏𝒆 𝒖𝒎𝒂 operadora 𝒂𝒃𝒂𝒊𝒙𝒐 ☟`, "*Sistema Escolhido ✅*", "Operadoras Disponíveis", botaoale)
break

case 'internetiosOFF':
if (args.length >= 800) return conn.sendMessage(from, {text: 'Máximo 800 caracteres'}, {quoted: info})
var nomor = info.participant
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\Alguém precisa de suporte no pv do Bot de vendas/atendimento.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Notificação enviada a nossa equipe de suporte, em breve entraremos em contato, aguarde.`)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "📱 Celular Android | TV Box", rowId: `${prefix}gerariptvandroid`, description: ""},
  {title: "📲 iPhone", rowId: `${prefix}gerariptvios`, description: ""},
  {title: "🌐 Navegador - Site (www)", rowId: `${prefix}gerarnavegador`, description: "Serve para celular e computador"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "Assista TV usando apenas internet !", `*〽️onteiro Tech - IPTV*
-
▫️ Canais *SD, HD, FHD, 4K & H.265*
▪️ Canais *Nacionais e Internacionais*
(Incluindo Globo (Gazeta) Regional) 
▫️Canais *Infantis*
▪️Canais Paperview
(BBB, A Fazenda e outros)
▫️Canais *Esportes*
(DAZN, SporTV, Combate, Premiere e outros)
▪️Filmes & Séries *(Netflix, Amazon Prime, GloboPlay e outros)*
▫️Novelas & Shows ao vivo

===========================

*Aparelhos Compatíveis:*
TV Box, Smartphone, Tablet, Celular, Computador, Notebook e iPhone. 

===========================`, "*Teste IPTV*", "Escolha aqui onde vai testar", botaoale)
break

case 'gerariptvandroid':
botaoale = [
{title: "Selecione a opção desejada:",
rows: [
  {title: "🔄 Gerar Dados", rowId: `${prefix}gerartesteiptvandroid`, description: ""},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: "️"}]
}]
sendlistA(from, "IPTV - TV", `\r*Aplicativos IPTV NOW* para TV BOX | Celular Android:
Clique, escolha Android / Box e baixe:
https://a.wonp.xyz/app

(Sugerimos o PLAYER N PRO)`, "*Aplicativo Android*", "Gerar Teste | Voltar", botaoale)
break

case 'gerartesteiptvandroid':
if (args.length >= 800) return conn.sendMessage(from, {text: 'Máximo 800 caracteres'}, {quoted: info})
var nomor = info.participant
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\Solicitação de Teste IPTV Android.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Solicitação enviada a nossa equipe de suporte, em breve entraremos em contato, aguarde.`)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "🔄 Gerar Dados", rowId: `${prefix}gerartesteiptvios`, description: ""},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "IPTV - iOS", `\rAplicativo Recomendado - *Smarters Player Lite*:
Baixe clicando aqui:\nhttps://apple.co/3RXZPnK`, "*Aplicativo iOS*", "Gerar Teste | Voltar", botaoale)
break

case 'gerartesteiptvios':
if (args.length >= 800) return conn.sendMessage(from, {text: 'Máximo 800 caracteres'}, {quoted: info})
var nomor = info.participant
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\Solicitação de Teste IPTV iOS.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Solicitação enviada a nossa equipe de suporte, em breve entraremos em contato, aguarde.`)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "🔄 Gerar Dados", rowId: `${prefix}gerartesteiptvnavegador`, description: ""},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "Player para Navegador: http://p.wonp.xyz",``, "*Navegador*", "Gerar Teste | Voltar", botaoale)
break

case 'gerartesteiptvnavegador':
if (args.length >= 800) return conn.sendMessage(from, {text: 'Máximo 800 caracteres'}, {quoted: info})
var nomor = info.participant
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\Solicitação de Teste IPTV Navegador.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Solicitação enviada a nossa equipe de suporte, em breve entraremos em contato, aguarde.`)
break
...
//inicio erros e problemas 

case 'erroseproblemas':
botaoale = [
{title: "Selecione a opção desejada:",
rows: [
  {title: "❌ Problemas na Internet 🌐", rowId: `${prefix}errosinternet`, description: "Problema no app de internet Android e iPhone"},
  {title: "❌ Problemas no IPTV (TV) 📺", rowId: `${prefix}errosiptv`, description: "Problema no app de IPTV (Tv Box, TV, Celular)"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: "️"}]
}]
sendlistA(from, "Passo a passo para resolver erros e problemas.", ``, "*Resolver Erros e Problemas*", "Selecione seu serviço aqui", botaoale)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "Aplicativo ANDROID", rowId: `${prefix}errosinternetandroid`, description: "Atlantus Tech 4G"},
  {title: "Aplicativo iPHONE", rowId: `${prefix}internetios`, description: "iOS"},
  {title: "Testar CHIP", rowId: `${prefix}testarchip`, description: "Serve para saber se seu chip está bloqueado"},
  {title: "🔄 Mudar de Operadora", rowId: `${prefix}trocardeoperadora`, description: "É necessário um CHIP da operadora escolhida"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "*Serviço selecionando:* Internet ilimitada", `\n*Dica Rápida: Reinicie seu celular e atualize o aplicativo com wi-fi !*\n\n*Menu -> Verificar Atualizações* e tente conectar novamente nos acessos da sua operadora.`, "*Tutoriais de Correção*", "Informe seu APP aqui", botaoale)
break

case 'errosinternetandroid':
botaoale = [
{title: "Selecione a opção desejada:",
rows: [
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
...
sendlistA(from, "*Serviço:* Internet ilimitada", `
*Dica Rápida: Reinicie seu celular e atualize o aplicativo !*
-
Alternativa 1:
*Clientes (Vivo | Tim | Claro | Oi)*
Clique aqui: https://bit.ly/3QKU2RV
-
Alternativa 2:
*Somente Clientes Operadora - VIVO*
Clique aqui: https://bit.ly/3AFJCNK
-
Alternativa 3:
*Somente Clientes Operadora - TIM*
Clique aqui: https://bit.ly/3dwydqV
-
*Verifique se seu CHIP está bloqueado ou desbloqueado:*
Clique aqui: https://bit.ly/3S5B3C2`, "*Tutoriais de Correção*", "Outras Opções", botaoale)
break

case 'errosinternetios':
botaoale = [
{title: "Selecione a opção desejada:",
rows: [
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
...
sendlistA(from, "*iOS*", `desativado`, "*Tutoriais de Correção*", "Outras Opções", botaoale)
break
...
sendlistA(from, "*Internet ilimitada*", `

❌ *Feche nosso aplicativo*
🔴 *Desligue o Wi-Fi*
🟢 *Ligue apenas os Dados Móveis*

Tente entrar no site correspondente a sua operadora:

*VIVO*
https://portalrecarga.vivo.com.br/recarga/home

*TIM*
https://www.tim.com.br/para-voce/recarga/recarga-express

*CLARO*
http://recarga.claro.com.br/no-credit

👉🏻 *Se o site carregar completamente, significa que seu chip está desbloqueado.*

👉🏻 *Se não carregar, significa que seu chip está bloqueado e precisa fazer uma recarga mínima para voltar a ultilizar o aplicativo.*

_Obs: Não serve entrar por Wi-Fi, precisa testar diretamente conectado nos *Dados Móveis* (sem pacote de internet ativo)._`, "*Teste de CHIP*", "Outras Opções", botaoale)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "⏰ Erro Date and Time", rowId: `${prefix}dataehora`, description: "Erro na DATA e HORA do aparelho"},
  {title: "❌ Travamento", rowId: `${prefix}travamentoiptv`, description: "Lentidão | Tela Preta | Canais Sumiram"},
  {title: "🔑 Alteração de Senha", rowId: `${prefix}errosenhaiptv`, description: "Aviso de alteração de senha"},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "*Serviço selecionando:* IPTV (TV)", ``, "*Resolver Erros e Problemas*", "Informe seu APP aqui", botaoale)
break
...
sendlistA(from, "*Reinicie seu TV BOX, ROTEADOR e conserte a data e hora do aparelho.*", ``, "*Tutoriais de Correção*", "Outras Opções", botaoale)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "📝 Outros Tutoriais", rowId: `${prefix}tutoriaisiptv`, description: "Entrar | Sair | Atualizar"},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "IPTV", `*Clique aqui:* https://bit.ly/3c5oClZ`, "*Tutoriais de Correção*", "Outras Opções", botaoale)
break

case 'errosenhaiptv':
reply(`*Nossa equipe já foi informada da sua solicitação, aguarde....*`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Solicitação de alteração de senha.*\n\n_Deseja confirmar a alteração ?_\n\nNúmero dele(a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [
{buttonId: `${prefix}avisosenhaiptv ${sender}`, buttonText: {displayText: `Sim`}, type: 1},], selo)
break

case 'avisosenhaiptv':
if(!SoDono) return reply("Só dono...")
await conn.sendMessage(q, {text: `Sua senha será alterada e informada assim que possível.`})
break

// fim erros e problemas
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "📱 APP de Internet Android", rowId: `${prefix}appinternetandroid`, description: "Android"},
  {title: "📲 APP de Internet iOS - iPhone", rowId: `${prefix}appinternetios`, description: "iPhone"},
  {title: "📺 APPs de IPTV - TV", rowId: `${prefix}appsiptv`, description: "Tv Box, Android, iPhone ou TV"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "*Loja de Aplicativos*", `𝒔𝒆𝒍𝒆𝒄𝒊𝒐𝒏𝒆 𝒖𝒎𝒂 APP 𝒂𝒃𝒂𝒊𝒙𝒐 ☟`, "*⬇️ Baixar Aplicativo ⬇️*", "Escolha um APP aqui", botaoale)
break

case 'appinternetandroid':
botaoale = [
{title: "Selecione a opção desejada:",
rows: [
  {title: "Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "Voltar ao Menu Principal", rowId: `${prefix}menu`, description: "↩️"}]
}]
sendlistA(from, "Internet ilimitada",`*Aplicativo - Android - (ATLANTUS TECH 4G)*

*Baixe e instale aqui*:
https://bit.ly/AtlantusTech4G
(após abrir, clique no botão DOWNLOAD para baixar)`, "*Aplicativo Android*", "Ajuda | Voltar", botaoale)
break

case 'appinternetios':
sendlistA(from, "*Temporariamente indisponível*.")
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "📺 TV BOX", rowId: `${prefix}apptvbox`, description: "TV Box"},
  {title: "📺 TV", rowId: `${prefix}apptv`, description: "Televisões"},
  {title: "📱 Smartphone Android", rowId: `${prefix}apptvbox`, description: "Android"},
  {title: "📲 iPhone", rowId: `${prefix}appios`, description: "iPhone"},
  {title: "🌐 Navegador", rowId: `${prefix}iptvnavegador`, description: "Navegador de computador ou celular"},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "IPTV", `𝒔𝒆𝒍𝒆𝒄𝒊𝒐𝒏𝒆 𝒖𝒎𝒂 OPÇÃO 𝒂𝒃𝒂𝒊𝒙𝒐 ☟`, "*Aplicativos*", "Escolha uma opção", botaoale)
break
...
(Sugerimos o PLAYER N PRO)
`, "*Aplicativo Android*", "Ajuda | Voltar", botaoale)
break
...
➡️ *Aplicativos TCL, AOC, PHILCO e PHILLIPS:*

       - DNS v1 pelo navegador
       - SS-IPTV pelo navegador
       - Clouddy (pago)
       - Bay IPTV (pago)

➡️ *Aplicativos TOSHIBA, MULTILASER (VIDAA):*

       - Smart STB (Via DNS)
       - IVI (Via DNS)
       - SS-IPTV

➡️ *Aplicativos TCL - Modelo Novo Android:*
...
➡️ *Aplicativos CHROMECAST/Celular IOS:*
       ...
       - IPTV Pro
       - IPTV Player&Cast
       - IPTV Smarters Player (Versão 3)

➡️ *Aplicativos Computador | Notebook:*
...
➡️ *Aplicativos XBOX ONE:*
       ...
       - Max Player
       - Best Player
       `, "*Aplicativo para TV*", "Ajuda | Voltar", botaoale)
break
...
sendlistA(from, "IPTV - iOS", `\rAplicativo Recomendado - Smarters Player Lite:
Baixe aqui:
https://apple.co/3RXZPnK

➡️ *Outros aplicativos:*
         ...
         - IPTV Pro
         - IPTV Player&Cast
         `, "*Aplicativo iOS - iPhone*", "Ajuda | Voltar", botaoale)
break

case 'iptvnavegador':
sendlistA(from, "*Player para Navegador: http://p.wonp.xyz*.")
break
...
case 'financeirogeral':
botaoale = [
{title: "Selecione a opção desejada:",
rows: [
  {title: "🧾 Enviar Comprovante", rowId: `${prefix}comprovante`, description: ""},
  {title: "📲 Pagar Internet Ilimitada", rowId: `${prefix}financeirovps`, description: ""},
  {title: "📺 Pagar IPTV (Canais, Filmes e Séries)", rowId: `${prefix}financeiro`, description: ""},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: "️"}]
}]
sendlistA(from, "Área de Pagamentos", ``, "*Setor Financeiro*", "Escolha seu serviço", botaoale)
break
...
rows: [
  {title: "🧾 Enviar Comprovante", rowId: `${prefix}comprovante`, description: ""},
  {title: "Pix", rowId: `${prefix}pix`, description: ""},
  {title: "Cartão de Crédito", rowId: `${prefix}cartao2`, description: "Mercado Livre | Pago"},
  {title: "Depósito | Transferência Bancária", rowId: `${prefix}tr`, description: "BB, Bradesco e Caixa Econômica"},
  {title: "PicPay", rowId: `${prefix}picpay`, description: ""},
  {title: "Ame Digital", rowId: `${prefix}amedigital`, description: ""},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "*Valor: R$ 15,00*\n\nAo efetuar o pagamento, você concordará automaticamente com nossos termos de uso: https://bit.ly/3R4dFER", ``, "*Setor Financeiro - Internet VPS*", "Aceito | Efetuar Pagamento", botaoale)
break
...
rows: [
  {title: "🧾 Enviar Comprovante", rowId: `${prefix}comprovante`, description: ""},
  {title: "Pix", rowId: `${prefix}pix`, description: ""},
  {title: "Cartão de Crédito", rowId: `${prefix}cartao`, description: "Mercado Livre | Pago"},
  {title: "Depósito | Transferência Bancária", rowId: `${prefix}tr`, description: "BB, Bradesco e Caixa Econômica"},
  {title: "PicPay", rowId: `${prefix}picpay`, description: ""},
  {title: "Ame Digital", rowId: `${prefix}amedigital`, description: ""},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
...
sendlistA(from, "*Valor: R$*", ``, "*Setor Financeiro - IPTV*", "Efetuar Pagamento", botaoale)
break
...
sendlistA(from, "*PIX*", `Chave Pix *Celular*:\n82981687783

Favorecido:
*Gabriel Josino Monteiro Cruz*\n*(Mercado Pago)*\n\nApós pagamento é necessário que clique em *ENVIAR COMPROVANTE 👇🏻*`, "*Pagamento via*", "Enviar Comprovante", botaoale)
break
...
rows: [
  {title: "🧾 Enviar Comprovante", rowId: `${prefix}comprovante`, description: ""},
  {title: "💳 Outro Valor", rowId: `${prefix}outrovalor`, description: "Pagar outro valor"},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "Varias opções de valores disponíveis, escolha o valor referente ao seu serviço:", `
Link de Pagamento *R$ 25,00*:
https://mpago.la/1ustu4g

Link de Pagamento *R$ 30,00*:
https://mpago.la/1DR6Bz9

Link de Pagamento *R$ 35,00*:
https://mpago.la/2irUixu

Link de Pagamento *R$ 50,00*
https://mpago.la/19AoHu9

Link de Pagamento *R$ 60,00*
https://mpago.la/1LgGNrY

Link de Pagamento *R$ 70,00*
https://mpago.la/2sGFiTW

\nApós pagamento é necessário que clique em *ENVIAR COMPROVANTE 👇🏻*
`, "*Pagamento via Mercado Pago | Livre*", "Enviar Comprovante | Outro Valor", botaoale)
break
...
sendlistA(from, "Mercado Pago | Livre", `Link de Pagamento *R$ 15,00*:
https://mpago.la/17Umsnc
\nApós pagamento é necessário que clique em *ENVIAR COMPROVANTE 👇🏻*`, "*Pagamento via*", "Enviar Comprovante", botaoale)
break
...
sendlistA(from, "Usuário: @monteirotech", `\n\nApós pagamento é necessário que clique em *ENVIAR COMPROVANTE 👇🏻*`, "*Pagamento via PICPAY*", "Enviar Comprovante", botaoale)
break
...
sendlistA(from, "Link de Pagamento: \nhttps://bit.ly/mtechame", `\n\nApós pagamento é necessário que clique em *ENVIAR COMPROVANTE 👇🏻*`,"*Pagamento via AME DIGITAL*", "Enviar Comprovante", botaoale)
break
...
{title: "Selecione a opção desejada:",
rows: [
  {title: "Banco do Brasil", rowId: `${prefix}bb`, description: ""},
  {title: "Bradesco", rowId: `${prefix}bra`, description: ""},
  {title: "Caixa Econômica Federal", rowId: `${prefix}cef`, description: ""},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: "️"}]
}]
sendlistA(from, "Transferência | Depósito", `\nApós pagamento é necessário que clique em *ENVIAR COMPROVANTE 👇🏻*`,"*Pagamento via*", "Escolha seu banco", botaoale)
break
...
sendlistA(from, "Banco do Brasil", `Agência: 0960-1
Conta Corrente: 15570-5

Favorecido: *Gabriel Josino Monteiro Cruz*\n\nApós pagamento é necessário que clique em *ENVIAR COMPROVANTE 👇🏻*`,"*Pagamento via*", "Enviar Comprovante", botaoale)
break
...
sendlistA(from, "Bradesco", `Agência: 6187-5
Conta Corrente: 433-2
...
sendlistA(from, "Caixa Econômica Federal", `Agência: 4548
Operação: 001
Conta Corrente: 23609-7
...
{title: "Selecione a opção desejada::",
rows: [
  {title: "❌ Resolver Erros e Problemas", rowId: `${prefix}errosiptv`, description: ""},
  {title: "🧑‍💻 Preciso de Ajuda", rowId: `${prefix}suporte`, description: "Falar com um Atendente"},
  {title: "↩️ Voltar ao Menu Principal", rowId: `${prefix}menu`, description: ""}]
}]
sendlistA(from, "Clique aqui: https://bit.ly/3xKNJpP", ``, "*Tutoriais para IPTV*", "Outras Opções", botaoale)
break
...
await conn.sendMessage(`558296283341@s.whatsapp.net`, {text: sug}, {quoted: info})
...
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\Alguém precisa de suporte no pv do Bot de vendas/atendimento.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Solicitação enviada a nossa equipe de suporte, aguarde...`)
break

case 'meusdados':
reply(`Nossa equipe já foi informada da sua solicitação, seus sados serão enviados durante o horário comercial.`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Solicitação de Dados de Acesso*\nNúmero dele (a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [], selo)
break

case 'comprovante':
reply(`Envie seu comprovante e aguarde para que possamos renovar / ativar seu pacote durante o horário comercial.`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Aviso - Envio de Comprovante*\nNúmero dele (a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [], selo)
break

case 'outrovalor':
reply(`Informe o valor do seu serviço.`)
sendBtext(`${setting.numerodono}@s.whatsapp.net`,`*Aviso - Outro Valor de Pagamento*\nNúmero dele (a) : wa.me/${sender.split("@")[0]}`, `Usuário dele: ${pushname}`, [], selo)
break

case 'mentoria':
if (args.length >= 800) return conn.sendMessage(from, {text: 'Máximo 800 caracteres'}, {quoted: info})
var nomor = info.participant
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\Alguém precisa de aplicação de mentoria.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Notificação enviada a nossa equipe de suporte, em breve entraremos em contato, aguarde.`)
break

case 'trocardeoperadora':
if (args.length >= 800) return conn.sendMessage(from, {text: 'Máximo 800 caracteres'}, {quoted: info})
var nomor = info.participant
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\Alguém precisa mudar de operadora.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Notificação enviada a nossa equipe de suporte, em breve entraremos em contato, aguarde.`)
break
...
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\SAC Acionado.`
await conn.sendMessage(`${setting.numerodono}@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Deixe sua mensagem abaixo:`)
break
